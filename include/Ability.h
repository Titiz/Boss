...
public:
	...
	std::vector<sf::Vector2i> rectangles; // If the ability uses an area of effect, it will have certain rectangles that it affects. We will specify size and coordinates away from caster.
